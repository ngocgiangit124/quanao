...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="/admin/danhmuc/{{$theloai['Id']}}/update" >
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="Name" value="{{$theloai['Name']}}" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Mã danh mục</label>
                                <input class="form-control" id="id-password" type="text" name="Code" value ="{{$theloai['Code']}}" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Mô tả</label>
                                <input class="form-control" type="text" name="Description" value="{{$theloai['Description']}}" required >
                            </div>
                        </div>
